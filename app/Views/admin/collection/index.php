...
<div id="printArea">
    ...
    <div class="print-header">
        <h2>SHANKAR NURSING HOME</h2>
        <p>Besides Hero Honda Agency, NH-7, Allahabad Road,Rewa, Madhya Pradesh</p>
        <p>Mobile: 9424507187 | Email: shrivastavaramprakash@yahoo.com</p>
    </div>
